...
// Creates a listOfChecks depending on the Postgres versions, with version specific checks
func createCheckList(version string) []checkFunc {
	...
	// lma checks same for all versions
	listOfChecks = append(listOfChecks, lmaChecks...)
